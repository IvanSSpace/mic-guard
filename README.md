...
- **Приоритет входов** — список всех обнаруженных микрофонов. У каждой строки:
  ...
  Физическое отключение микрофона работает так же само по себе: устройство просто выпадает из списка доступных, а при переподключении возвращается на свою сохранённую позицию в приоритете — ничего дополнительно нажимать не нужно.
